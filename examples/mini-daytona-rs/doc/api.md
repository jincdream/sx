...
mini-daytona-rs 提供基于 Axum 的 REST API，监听在 `0.0.0.0:3000`。

通过 `mini-daytona-rs server` 命令启动 API 服务。
...
```json
{
  "success": true,
  "data": {
    "snapshot_path": "/root/.mini-daytona/snapshots/uuid-dir",
...
```json
{
  ...
  "data": {
    "snapshots": [
      {
        "id": "uuid",
        "path": "/root/.mini-daytona/snapshots/uuid-dir",
    ...
    "sandboxes": [
      {
        ...
        "snapshot_id": "",
        "created_at": "2026-03-03T10:00:00+00:00",
        "dir": "/root/.mini-daytona/sandboxes/uuid"
      }
    ]
  },
  "error": null
...
```json
{
  "path": "/home/daytona/workspace/data.xlsx",
  "data": "UEsDBBQAAAA..."
}
```
...
{
  "success": true,
  "data": "File /home/daytona/workspace/data.xlsx uploaded successfully (10535055 bytes)",
  "error": null
}
```
...
**GET** `/api/sandbox/{id}/download?path=/home/daytona/workspace/data.xlsx`
...
curl -X POST http://localhost:3000/api/start \
  -H "Content-Type: application/json" \
  -d '{"snapshot": "/root/.mini-daytona/snapshots/uuid-dir"}'
